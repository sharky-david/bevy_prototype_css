...
//! and `Color`s using a CSS stylesheet supplied as an asset.  It is otherwise as close a
//! replication of the original as possible.
...
fn setup(mut commands: Commands, asset_server: Res<AssetServer>) {
    ...
    let background = commands
        ...
        .insert(CssId::from("background-container"))
